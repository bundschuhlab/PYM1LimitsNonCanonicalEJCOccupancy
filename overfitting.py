...
#
# File for training a model and plotting the training and
...
#model_name = "overfitting_test_permuted_"+optimizer
model_name = "overfitting_test_"+optimizer
...
# Shuffle the targets so features and targets are unrelated.
...
training_features,validation_features,training_targets,validation_targets = ML_functions.create_splits(features,
                                                                                                       ...
                                                                                                       learning_rate,
                                                                                                       step)
ML_functions.train_models_overfitting(Return,
                          build,
                          training_features,
                          training_targets,
                          validation_features,
...
loss1 = np.load(place+"loss_arrays/training_loss_"+model_name+"_"+str(num_features)+"_"+str(batch_size)+"_"+str(num_epochs)+"_"+str(learning_rate)+"_0.npy")
loss2 = np.load(place+"loss_arrays/validation_loss_"+model_name+"_"+str(num_features)+"_"+str(batch_size)+"_"+str(num_epochs)+"_"+str(learning_rate)+"_0.npy")
...
plt.savefig(place+model_name+"_"+str(num_features)+"_"+str(batch_size)+"_"+str(num_epochs)+"_"+str(learning_rate)+"_0.png")
